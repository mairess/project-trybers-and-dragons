...
class Character implements Fighter {
  ...
  get energy(): Energy { return { ...this._energy } as Energy; }
  ...
  levelUp(): void {
    const increasedLifePoints = this._maxLifePoints + getRandomInt(1, 10);
    this._maxLifePoints = Math.min(increasedLifePoints, this.race.maxLifePoints);
    this._strength += getRandomInt(1, 10);
    this._dexterity += getRandomInt(1, 10);
    this._defense += getRandomInt(1, 10);
  ...
  special(): void { this._strength = 10; }
}
